...
def index():
    ...
    return render_template("index.html", user_rows=user_rows, user_rows_length=user_rows_length, cash=cash, account_value=account_value, uprows=user_purchase_rows)
